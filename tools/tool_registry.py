...
TOOL_REGISTRY = {
    ToolType.PENCIL:   {"icon": ICON_PATH + "pencil.png", "tooltip": "Pencil drawing", "shortcut": "F"},
    ...
    ToolType.ERASER:   {"icon": ICON_PATH + "del.png", "tooltip": "Eraser (white brush)", "shortcut": "E"},
